...
// --- Icons ---
const SquadHeroIcon = () => (
  <svg className="w-16 h-16 text-[#009A44] opacity-20 absolute top-4 right-10 transform rotate-12" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-5.5-2.5l7.51-3.49L17.5 6.5 9.99 9.99 6.5 17.5zm5.5-6.6c.61 0 1.1.49 1.1 1.1s-.49 1.1-1.1 1.1-1.1-.49-1.1-1.1.49-1.1 1.1-1.1z"/></svg>
);
      ...
      <div className="bg-white shadow-sm relative overflow-hidden mb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10 text-center md:text-left">
           ...
           <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">
             National <span className="text-[#009A44]">Squad</span>
           </h1>
           ...
           <div className="flex flex-col md:flex-row items-center gap-4 text-sm font-bold uppercase tracking-widest text-gray-400 mb-6">
             <span>The Walias (ዋልያዎቹ)</span>
             <span className="hidden md:inline">•</span>
             <span className="font-amharic text-[#009A44]">የብሔራዊ ቡድን ተጫዋቾች</span>
           </div>

           <p className="max-w-2xl text-lg text-gray-600 leading-relaxed">
             Meet the stars representing Ethiopia on the international stage. 
             Discover the talent, passion, and dedication behind every player 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        {players.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-dashed border-gray-300 p-20 text-center">
             <EmptyStateIcon />
             <h3 className="text-xl font-bold text-gray-900">No Players Found</h3>
             <p className="text-gray-500 mt-2">The squad list is currently empty.</p>
          </div>
        ) : (
          // Players Grid
        ...
        <div className="mt-16 text-center">
           <p className="text-xs text-gray-400 uppercase tracking-widest font-bold">
             Official Roster • Ethiopian Football Federation
           </p>
        </div>
      </div>
    </div>
